...
/*
 * LAYOUT: Oversized number dominates the frame
 * ┌──────────────────┐
 * │    ALTVEDA        │
 * │                   │
 * │                   │
 * │                   │
 * │     20x           │  HUGE number (260px+)
 * │                   │  fills the visual center
 * │                   │
 * │  ───              │  thin accent line
 * │                   │
 * │  More Vitamin C   │  Label (56px)
 * │  than oranges     │
 * │                   │
 * │  Context body     │  Body (44px)
 * │  text here        │
 * │                   │
 * │    altveda.in     │
 * └──────────────────┘
...
export const StatReveal: React.FC<StatRevealProps> = ({
  ...
  // Counter with satisfying ease-out deceleration
  ...
  // Botanical in background — subtle but visible on dark
  ...
  return (
    <AbsoluteFill style={{ opacity: exit }}>
      ...
      {/* Botanical — ghostly on dark, adds texture */}
      {backgroundImage && (
        <Img
      ...
      <div style={{
        ...
        {/* THE NUMBER — massive, dominates the frame */}
        <div style={{
          fontFamily: FONTS.heading, fontSize: 260, fontWeight: 700,
        ...
        <div style={{
          fontFamily: FONTS.heading, fontSize: 56, fontWeight: 600,
